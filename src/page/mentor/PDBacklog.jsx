        ...
        <table className='w-[90%] shadow-md rounded-lg mt-3 ml-[75px] text-black'>
          ...
          <tbody>
            <tr>
              ...
              <td className='p-2 text-[20px]'>สุพรรษา มูลศิริ</td>
              ...
              <td className='text-center'>
                <span className="block w-9 h-9 mt-2 ml-7 bg-cover cursor-pointer" style={{ backgroundImage: "url('/src/img/img_icon/2666505.png')",justifyContent:'center' }} onClick={gotoBLProject}></span>
              </td>
            </tr>
            <tr>
              ...
              <td className='text-center'>
                <span className="block w-9 h-9 mt-2 ml-7 bg-cover cursor-pointer text-center" style={{ backgroundImage: "url('/src/img/img_icon/2666505.png')" }} onClick={gotoBLProject}></span>
              </td>
            </tr>
          </tbody>
        </table>
