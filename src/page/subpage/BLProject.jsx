      ...
      <div>
        ...
        <main className='MBL'>
          ...
          <div className='back-th-1'>
            <img src="/src/img/img_icon/back-button.png" className='back-1' onClick={GotoBL} /> {/* ปุ่มย้อนกลับ */}
          </div>
                ...
                <tbody>
                    ...
                    <tr key={index}>
                      {editRowIndices.includes(index) ? (
                        <>
                          ...
                          <td><textarea placeholder="ระบุไว้" type="text" value={row.type} onChange={(e) => handleChange(e, 'type', index)} className='IP-1' /></td>
                          <td><textarea placeholder="ระบุไว้" type="text" value={row.detail} onChange={(e) => handleChange(e, 'detail', index)} className='IP-1' /></td>
                          <td>
                          ...
                          <td><textarea placeholder="ระบุไว้" type="text" value={row.responsible} onChange={(e) => handleChange(e, 'responsible', index)} className='IP-1' /></td>
                          <td>
                            <select 
                              value={row.status || ""} 
                          ...
                          <td><textarea placeholder="ระบุไว้" type="text" value={row.remark} onChange={(e) => handleChange(e, 'remark', index)} className='IP-1' /></td>
                          <td>
                  ...
                  {newRow && (
                    <tr>
                      ...
                      <td><textarea placeholder="ระบุไว้" type="text" value={newRow.type} onChange={(e) => handleChange(e, 'type')} className='IP-1' /></td>
                      <td><textarea placeholder="ระบุไว้" type="text" value={newRow.detail} onChange={(e) => handleChange(e, 'detail')} className='IP-1' /></td>
                      <td>
                      ...
                      <td><textarea placeholder="ระบุไว้" type="text" value={newRow.responsible} onChange={(e) => handleChange(e, 'responsible')} className='IP-1' /></td>
                      <td>
                        <select
                          value={newRow.status || ""}
                      ...
                      <td><textarea placeholder="ระบุไว้" type="text" value={newRow.remark} onChange={(e) => handleChange(e, 'remark')} className='IP-1' /></td>
                      <td>
