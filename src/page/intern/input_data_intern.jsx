...
function input_data_intern() {
    ...
    return (
        <>
            <NavbarIntern/>
            <div className="max-w-[95%] mx-auto mt-12 mb-5  p-2 bg-white shadow-lg rounded-lg text-left " style={{ fontSize: '30px' }}>
                <h3 className='ml-5'>
                    กรอกข้อมูลส่วนตัว
                </h3>
            </div>
            <div className="max-w-[95%] mx-auto my-6 p-8 bg-white shadow-lg rounded-lg">
                <form className="space-y-6 text-left" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6" style={{gridRowGap:'20px'}}>
                        ...
                        <div>
                            <label className="block text-xl font-medium text-gray-700">รหัสนักศึกษาฝึกงาน<span style={{ color: 'red' }}>*</span></label>
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={internId} onChange={(e) => setInternId(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                            <label className="block text-xl font-medium text-gray-700">อายุ<span style={{ color: 'red' }}>*</span></label>
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={age} onChange={(e) => setAge(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={idCard} onChange={(e) => setIdCard(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="email" value={email2} onChange={(e) => setEmail2(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                            <label className="block text-xl font-medium text-gray-700">Email (ใช้สำหรับ Microsoft Teams)<span style={{ color: 'red' }}>*</span></label>
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="email" value={email3} onChange={(e) => setEmail3(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                        ...
                        <div className="col-span-2">
                            ...
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={address} onChange={(e) => setAddress(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div className="col-span-2">
                            <label className="block text-xl font-medium text-gray-700">ที่อยู่ปัจจุบัน<span style={{ color: 'red' }}>*</span></label>
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={currentAddress} onChange={(e) => setCurrentAddress(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div className="col-span-2">
                        ...
                        <div className="col-span-2">
                            ...
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={educationLevel} onChange={(e) => setEducationLevel(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div className="col-span-2">
                        ...
                        <div>
                            ...
                            <input className="mt-2 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" type="text" value={gpa} onChange={(e) => setGpa(e.target.value)} placeholder="โปรดระบุ" required />
                        </div>
                        <div>
                        ...
                        <div className="col-span-4">
                            <label className="block text-xl font-medium text-gray-700">โปรดเลือกสายงานที่ถนัดที่สุด<span style={{ color: 'red' }}>*</span></label>
